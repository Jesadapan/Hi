...
<body>
  ...
  <div class="container">  
         <div class="font"> <br>
          ...
          <div class="row">
              <input type="text" id="LATI" placeholder="Latitude" class="form-control" style="width: 50%; margin-left: 30px; margin-top: 20px;" > 
              <input type="text" id="LONG" placeholder="Longitude" class="form-control" style="width: 50%; margin-left: 30px;  margin-top: 20px; "> 
             <button id="discover" class="btn btn-warning btn-sm" style=" width: 20%; color: white; box-shadow: 0 2px 4px 0 rgb(20, 0, 0); margin-left: 20px; margin-top: 20px;"><b>Load</b></button>
